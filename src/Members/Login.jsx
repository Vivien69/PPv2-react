    ...
    <div className="text-left">
        <div className="w-full md:flex">
            ...
            <div className="w-full md:w-2/3 bg-white pr-5 pl-5 pb-5 rounded-lg lg:rounded-l-none">
                <h3 className="text-xl font-semibold text-center mb-2">Connexion</h3>
                ...
                <div className='flex sm:justify-between flex-col sm:flex-row mt-6'>
                    ...
                    <Link to='/login' className='hover:text-red-800'  onClick={props.CloseModal}>Créer un nouveau compte</Link>
                </div>
            </div>
